...
- **Automatización:** existe una skill de Codex (`publish-post-blog-aunitz`) que automatiza la conversión de Word → HTML y la creación del fichero de post con metadatos e imágenes
