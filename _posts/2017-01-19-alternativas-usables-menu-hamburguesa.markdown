...
<h3>Ejemplo: BBC</h3>
<p><img src="{{ site.baseurl }}/img/bbc-menu.gif" loading="lazy" alt="Menú progresivo de la BBC con varias secciones visibles en una barra horizontal negra y un campo de búsqueda a la derecha" width="800" height="31"></p>
