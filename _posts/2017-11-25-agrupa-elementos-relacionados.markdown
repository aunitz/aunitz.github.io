...
<p><img src="{{ site.baseurl }}/img/tip-9-agrupa-elementos-relacionados.png" loading="lazy" alt="Pantalla con secciones y enlaces agrupados visualmente para facilitar la comprensión de elementos relacionados" width="722" height="428"></p>