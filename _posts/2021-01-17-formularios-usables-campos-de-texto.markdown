...
<p><img src="{{ site.baseurl }}/img/formularios-usables-campos-de-texto.png" loading="lazy" alt="Wireframe de formulario con campos de nombre de producto y descripción" width="521" height="463"></p>
