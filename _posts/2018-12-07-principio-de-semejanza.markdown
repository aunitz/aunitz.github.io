...
<p><img src="{{ site.baseurl }}/img/ley-14-principio-de-semejanza.png" loading="lazy" alt="Matriz de puntos negros y rojos donde los puntos del mismo color se perciben como grupos relacionados" width="722" height="294"></p>
