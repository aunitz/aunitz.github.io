...
<p><img src="{{ site.baseurl }}/img/tip-14-emplea-valores-por-defecto-utiles-en-formularios.png" loading="lazy" alt="Comparación entre un formulario con valores por defecto ya seleccionados y otro tachado que obliga a completar todos los campos desde cero" width="722" height="428"></p>
