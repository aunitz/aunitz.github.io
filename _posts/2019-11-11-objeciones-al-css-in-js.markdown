...
<p><img src="{{ site.baseurl }}/img/objeciones-al-css-in-js.png" loading="lazy" alt="Ilustración con un monitor y el texto CSS-in-JS, representando estilos CSS integrados en JavaScript" width="722" height="425"></p>
