...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-01.png" loading="lazy" alt="Tres insignias de conformidad WCAG 2.1: A, AA y AAA" width="699" height="80"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-02.jpg" loading="lazy" alt="Tres figuras de monos que representan no ver, no oír y no hablar" width="722" height="363"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-03.png" loading="lazy" alt="Esquema de una página web con regiones de cabecera, navegación, contenido, aside y pie" width="521" height="430"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-04.gif" loading="lazy" alt="Fragmento de código HTML con una imagen smiley.gif y el atributo alt Cara sonriente" width="392" height="33"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-05.gif" loading="lazy" alt="Fragmento de código HTML con una etiqueta label asociada a un campo de búsqueda" width="294" height="38"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-06.gif" loading="lazy" alt="Texto comparando formulaciones sobre personas con discapacidad y personas sin discapacidad" width="627" height="157"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-07.png" loading="lazy" alt="Informe de contraste WCAG con varios resultados fallidos marcados en rojo" width="478" height="376"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-08.png" loading="lazy" alt="Informe de contraste WCAG con resultados correctos marcados en gris" width="478" height="377"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-09.png" loading="lazy" alt="Tabla de estado que combina colores e iconos para no depender solo del color" width="496" height="157"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-10.png" loading="lazy" alt="Comparación entre un enlace descriptivo Recetas de ensalado y un enlace ambiguo Clic aquí" width="187" height="67"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-11.png" loading="lazy" alt="Comparación de textos de enlace recomendados frente a enlaces genéricos como pinchando aquí" width="558" height="67"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-12.jpg" loading="lazy" alt="Mano usando una tablet con una interfaz visual abierta" width="722" height="363"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-13.png" loading="lazy" alt="Enlace con el texto Is there anything wrong with this page? destacado en una franja azul" width="345" height="69"></p>
...
<p><img src="{{ site.baseurl }}/img/accesibilidad-web-al-alcance-de-todos-14.jpg" loading="lazy" alt="Página de inicio de Google en un teléfono móvil" width="722" height="363"></p>
