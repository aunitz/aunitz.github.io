...
<p><img src="{{ site.baseurl }}/img/ley-05-ley-de-miller.png" loading="lazy" alt="Comparación entre contenido dividido en grupos manejables y una página tachada con demasiada información junta" width="722" height="428"></p>
