...
<p><img src="{{ site.baseurl }}/img/tip-16-faculta-manipulacion-directa.png" loading="lazy" alt="Comparación entre una tabla editable directamente y una versión tachada que obliga a modificar datos en una pantalla separada" width="722" height="428"></p>
