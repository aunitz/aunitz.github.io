...
<p><img src="{{ site.baseurl }}/img/experiencia-de-usuario-versus-interfaz-de-usuario-01.jpg" loading="lazy" alt="Portada del libro Investigación a la interfaz de Adolfo Manes junto al concepto de experiencia de usuario" width="425" height="551"></p>
...
<p><img src="{{ site.baseurl }}/img/experiencia-de-usuario-versus-interfaz-de-usuario-02.png" loading="lazy" alt="Diagrama que muestra la interfaz de usuario como una parte de la experiencia de usuario" width="720" height="403"></p>
