...
<p><img src="{{ site.baseurl }}/img/formularios-usables-consejos-de-diseno.png" loading="lazy" alt="Wireframe de formulario con campos de nombre, apellidos, teléfono y correo electrónico" width="722" height="444"></p>
...
<ul>
	...
	<li>El <a href="{{ site.baseurl }}{% post_url 2021-01-17-formularios-usables-botones %}">texto del botón</a> debe describir de la manera más precisa posible la acción que realiza. Preferiblemente mediante un verbo simple. Como “Guardar”, “Continuar”, “Aceptar”, etc.</li>
	...
	<li>Las etiquetas de los campos (labels), mejor por encima. Si te interesa conocer los motivos, <a href="{{ site.baseurl }}{% post_url 2018-03-11-etiquetas-por-encima-campos %}">tienes todos los detalles en un post que publiqué</a> hace unos años.</li>
	...
	<li>No utilices el atributo <code>placeholder</code>. ¿Te sorprende este consejo? Hay un post en el que explico los <a href="{{ site.baseurl }}{% post_url 2020-01-29-no-utilices-atributo-placeholder %}">múltiples motivos que lo justifican</a>.</li>
</ul>
