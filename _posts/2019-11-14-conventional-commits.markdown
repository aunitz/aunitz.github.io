...
<p><img src="{{ site.baseurl }}/img/conventional-commits.jpg" loading="lazy" alt="Portátil con código en pantalla sobre una mesa de trabajo, representando el uso de Conventional Commits en desarrollo" width="722" height="435"></p>
