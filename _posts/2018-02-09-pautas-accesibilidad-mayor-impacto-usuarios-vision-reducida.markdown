...
<p><img src="{{ site.baseurl }}/img/pautas-accesibilidad-mayor-impacto-usuarios-vision-reducida-1.png" loading="lazy" alt="Comparación entre enlaces subrayados distinguibles y una versión tachada donde los enlaces apenas se diferencian del texto" width="722" height="428"></p>
...
<p><img src="{{ site.baseurl }}/img/pautas-accesibilidad-mayor-impacto-usuarios-vision-reducida-2.png" loading="lazy" alt="Comparación entre texto con buen contraste y una versión tachada con bajo contraste sobre fondo claro" width="722" height="428"></p>
...
<p><img src="{{ site.baseurl }}/img/pautas-accesibilidad-mayor-impacto-usuarios-vision-reducida-3.png" loading="lazy" alt="Comparación entre una página móvil que permite ampliar el contenido y otra tachada donde el zoom queda bloqueado" width="569" height="549"></p>
