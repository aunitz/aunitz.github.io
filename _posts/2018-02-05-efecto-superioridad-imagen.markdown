...
<p><img src="{{ site.baseurl }}/img/ley-11-efecto-superioridad-imagen.png" loading="lazy" alt="Comparación entre la palabra bici acompañada por un icono de bicicleta y una versión tachada donde solo aparece el texto" width="722" height="428"></p>
