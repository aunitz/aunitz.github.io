...
<p><img src="{{ site.baseurl }}/img/relacion-estetica-usabilidad.jpg" loading="lazy" alt="Teléfono con una pantalla de diseño abierta, representando la relación entre estética y usabilidad" width="722" height="411"></p>
...
<p>En otras palabras, <strong>el diseño juega un papel muy relevante en la experiencia de usuario</strong>. El diseño estéticamente agradable provoca el <a href="{{ site.baseurl }}{% post_url 2025-02-07-efecto-halo %}">efecto secundario de que el producto parezca más usable y profesional</a>.</p>
