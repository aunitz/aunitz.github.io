...
<p><img src="{{ site.baseurl }}/img/campos-de-material-design-mal-disenados-01.gif" loading="lazy" alt="Campo Localidad de Material Design con etiqueta flotante dentro del borde inferior" width="234" height="80"></p>
...
<p><img src="{{ site.baseurl }}/img/campos-de-material-design-mal-disenados-02.png" loading="lazy" alt="Campos Nombre y Apellidos con etiquetas flotantes de Material Design" width="229" height="144"></p>
...
<p><img src="{{ site.baseurl }}/img/campos-de-material-design-mal-disenados-03.png" loading="lazy" alt="Captura de un formulario móvil de Material Design con errores de contraste marcados" width="482" height="651"></p>

<p><strong>3. Las etiquetas largas se cortan en Material Design.</strong></p>

<p><img src="{{ site.baseurl }}/img/campos-de-material-design-mal-disenados-04.png" loading="lazy" alt="Campo Correo electrónico de Material Design con etiqueta flotante" width="227" height="65"></p>
...
<p><img src="{{ site.baseurl }}/img/campos-de-material-design-mal-disenados-05.png" loading="lazy" alt="Wireframe que compara campos de formulario con etiqueta visible frente a campos de Material Design tachados" width="410" height="347"></p>
