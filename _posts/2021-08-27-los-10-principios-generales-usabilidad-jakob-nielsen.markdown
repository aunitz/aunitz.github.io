...
<p>Mientras que la <strong>eficiencia de uso</strong> se relaciona con proporcionar a los usuarios expertos <strong>mecanismos adicionales para acelerar la interacción</strong>. Como por ejemplo los atajos de teclado y los gestos táctiles.</p>
...
<p>El principio de diseñar interfaces minimalistas está recogido en mi listado cuando se dice que se debe <strong>evitar la sobrecarga de información</strong>.</p>
...
<p>Estos mensajes de error también deben presentarse con tratamientos visuales que ayudarán a los usuarios a percibirlos y reconocerlos.</p>
...
<p>El contenido de la <strong>ayuda</strong> y la documentación debe ser <strong>fácil de buscar</strong> y debe ser <strong>conciso</strong> y <strong>centrarse en la tarea del usuario</strong>.</p>
