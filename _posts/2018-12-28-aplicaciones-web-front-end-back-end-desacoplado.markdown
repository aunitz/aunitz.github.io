...
<p><img src="{{ site.baseurl }}/img/front-end-back-end-desacoplado-01.jpg" loading="lazy" alt="Código fuente en un editor, representando la capa front-end de una aplicación web" width="722" height="339"></p>
...
<p><img src="{{ site.baseurl }}/img/front-end-back-end-desacoplado-02.jpg" loading="lazy" alt="Servidores en un centro de datos, representando la capa back-end de una aplicación web" width="722" height="339"></p>
...
<p><img src="{{ site.baseurl }}/img/front-end-back-end-desacoplado-03.jpg" loading="lazy" alt="Portátil con un panel de analítica abierto, como ejemplo de aplicación web construida sobre front-end y back-end desacoplados" width="722" height="339"></p>
...
<p><img src="{{ site.baseurl }}/img/front-end-back-end-desacoplado-04.jpg" loading="lazy" alt="Persona revisando wireframes en una pared durante el diseño de una aplicación web" width="722" height="481"></p>
