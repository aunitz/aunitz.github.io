...
<p><img src="{{ site.baseurl }}/img/ley-07-efecto-de-posicion-serial.png" loading="lazy" alt="Fila de puntos donde el primero y el último aparecen destacados, representando el efecto de posición serial" width="722" height="112"></p>
