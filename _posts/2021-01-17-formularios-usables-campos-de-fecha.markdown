...
<p><img src="{{ site.baseurl }}/img/formularios-usables-campos-de-fecha.png" loading="lazy" alt="Wireframe de formulario con campos separados para día, mes y año de nacimiento" width="521" height="275"></p>
