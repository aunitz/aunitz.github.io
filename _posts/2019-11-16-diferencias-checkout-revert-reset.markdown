...
<p><img src="{{ site.baseurl }}/img/checkout-revert-reset-1.png" loading="lazy" alt="Diagrama de ramas de Git con un commit destacado y una flecha hacia el estado inicial para explicar checkout" width="722" height="225"></p>
...
<p><img src="{{ site.baseurl }}/img/checkout-revert-reset-2.png" loading="lazy" alt="Diagrama antes de ejecutar git reset, con las ramas master y feature apuntando a commits distintos" width="722" height="321"></p>
...
<p><img src="{{ site.baseurl }}/img/checkout-revert-reset-3.png" loading="lazy" alt="Diagrama después de ejecutar git reset, con la rama movida a un commit anterior y cambios en el historial" width="722" height="321"></p>
...
<p><img src="{{ site.baseurl }}/img/checkout-revert-reset-4.png" loading="lazy" alt="Diagrama antes de ejecutar git revert, con un commit de la rama feature marcado como objetivo" width="722" height="321"></p>
...
<p><img src="{{ site.baseurl }}/img/checkout-revert-reset-5.png" loading="lazy" alt="Diagrama después de ejecutar git revert, con un nuevo commit que deshace los cambios sin reescribir el historial" width="722" height="321"></p>
