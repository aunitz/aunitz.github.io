...
<p><img src="{{ site.baseurl }}/img/ventajas-diseno-interfaz-personalizado-1.jpg" loading="lazy" alt="Pantalla de diseño de interfaz en un monitor de escritorio durante la creación de una solución personalizada" width="722" height="386"></p>
...
<p><img src="{{ site.baseurl }}/img/ventajas-diseno-interfaz-personalizado-2.jpg" loading="lazy" alt="Cuaderno con el texto Life is UX junto a un portátil, como referencia al diseño de experiencias de usuario a medida" width="722" height="363"></p>
