...
<p><img src="{{ site.baseurl }}/img/tip-6-destacar-llamadas-a-la-accion.png" loading="lazy" alt="Comparación entre una llamada a la acción principal resaltada y una pantalla tachada con varios botones secundarios compitiendo por la atención" width="722" height="428"></p>