...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-01.png" loading="lazy" alt="Menú de configuración de GitHub con la opción Pages seleccionada" width="925" height="71"></p>

<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-02.png" loading="lazy" alt="Campo Custom domain de GitHub Pages con un dominio propio escrito" width="289" height="170"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-03.png" loading="lazy" alt="Repositorio en GitHub mostrando archivos assets, CNAME y README.md" width="443" height="112"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-04.png" loading="lazy" alt="Pantalla de GitHub indicando que se ha creado el archivo CNAME" width="514" height="220"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-05.png" loading="lazy" alt="Resumen de commit en GitHub con el archivo CNAME añadido" width="344" height="217"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-06.png" loading="lazy" alt="Aviso amarillo de GitHub Pages mientras se comprueba la configuración DNS" width="833" height="150"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-07.png" loading="lazy" alt="Campo Custom domain con confirmación verde de dominio guardado" width="426" height="99"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-08.png" loading="lazy" alt="Mensaje de GitHub Pages indicando que el sitio está publicado en el dominio personalizado" width="845" height="244"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-09.png" loading="lazy" alt="Configuración DNS con un registro A apuntando a GitHub Pages" width="675" height="94"></p>
...
<p><img src="{{ site.baseurl }}/img/como-crear-pagina-web-gratis-github-pages-segunda-parte-10.png" loading="lazy" alt="Página web publicada en un dominio propio tras configurar GitHub Pages" width="722" height="519"></p>
