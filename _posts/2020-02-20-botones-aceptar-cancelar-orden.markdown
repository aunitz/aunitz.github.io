...
<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-01.png" loading="lazy" alt="Botones Aceptar y Cancelar con Aceptar como acción principal a la izquierda" width="187" height="49"></p>

<p>¿Primero el secundario y a continuación el principal?</p>

<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-02.png" loading="lazy" alt="Botones Cancelar y Aceptar con Aceptar como acción principal a la derecha" width="188" height="49"></p>
...
<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-03.png" loading="lazy" alt="Diálogo de Windows para eliminar un archivo con botones Sí y No" width="482" height="242"></p>

<p>Las pautas de <strong>Apple MacOS</strong> establecen justo lo contrario.</p>

<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-04.png" loading="lazy" alt="Diálogo de confirmación de iTunes para eliminar una lista de reproducción con Cancel y Delete" width="537" height="209"></p>

<p>Mientras que <strong>Google Android</strong> se decanta por la misma ubicación que Apple.</p>

<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-05.png" loading="lazy" alt="Selector de idioma del iPhone con las acciones Cancel y Done en la parte inferior" width="300" height="372"></p>
...
<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-06.png" loading="lazy" alt="Botones Aceptar y Cancelar con la acción principal alineada a la izquierda" width="180" height="48"></p>
...
<p><img src="{{ site.baseurl }}/img/botones-aceptar-cancelar-orden-07.png" loading="lazy" alt="Modal para eliminar un documento con Cancelar y Sí, eliminar como acción destructiva" width="517" height="225"></p>
